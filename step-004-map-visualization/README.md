...
1. If you haven't already, clone the current Git repository (`git clone https://github.com/Azure/iot-workshop-asset-tracking`).
...
3. In the terminal, navigate to the `step-004-map-visualization/webapp/` folder
